...
![Network topology](images/screenshot1.png)
...
### PC0
![PC0 IP configuration](images/screenshot2.png)

### PC1
![PC1 IP configuration](images/screenshot3.png)

### PC2
![PC2 IP configuration](images/screenshot4.png)

### PC3
![PC3 IP configuration](images/screenshot5.png)
...
![R1 interface configuration - part 1](images/screenshot6.png)

![R1 interface configuration - part 2](images/screenshot7.png)
...
![R1 BGP configuration - part 1](images/screenshot8.png)

![R1 BGP configuration - part 2](images/screenshot9.png)
...
![show ip bgp summary - part 1](images/screenshot10.png)

![show ip bgp summary - part 2](images/screenshot11.png)
...
![show ip route bgp](images/screenshot12.png)
...
![Ping PC0 to PC2](images/screenshot13.png)

### PC2 → PC0 (`ping 172.16.1.10`)
4/4 replies, 0% loss.

![Ping PC2 to PC0](images/screenshot14.png)
